...
public class ContentController {
	...
	@ResponseBody
	public Object creatContentCategory(Long parentId,String name){
		Map<String,Object> map = new HashMap<String ,Object>();
		try {
			contentCategoryService.andContentCategory(parentId, name);
			map.put("status", 200);
			map.put("msg", "添加成功");
		} catch (Exception e) {
			map.put("status", 200);
	...
	@ResponseBody
	public Object saveConten(Content content){
		Map<String,Object> map = new HashMap<String ,Object>();
		try {
